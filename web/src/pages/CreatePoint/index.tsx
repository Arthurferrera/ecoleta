...
const CreatePoint = () => {
  ...
  return (
    <>
      <div id="mensagem-sucesso" className={mensagemSucesso ? 'visible' : ''}>
        <FiCheckCircle size={56} color="#34CB79" />
